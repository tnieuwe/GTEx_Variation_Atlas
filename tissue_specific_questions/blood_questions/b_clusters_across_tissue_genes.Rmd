...
model_skin_m3 <- summary(lm(skin_zscore ~ TRISCHD, data = fat_skin))
model_skin_m3_plus <- summary(lm(skin_zscore ~ TRISCHD * DTHHRDY_factor, data = fat_skin))
model_skin_m4 <- summary(lm(skin_zscore ~ HBA1 + TRISCHD, data = fat_skin))
