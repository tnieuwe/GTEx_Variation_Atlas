...
Load data
```{r}
load("data_in/lung_vst.rda")
lung_clusts <- read.csv("../../../GTEx_variation/v8_output/lung-gene-clusters-high-variance.csv")
lung_profiles <- read.csv("../../../GTEx_variation/v8_output/lung-cluster-profiles.csv")
...
excel_out  <- list(coGAPS_patterns_5 = cog_analysis_d,
             coGAPS_patterns_8 = cog_analysis_e,
             coGAPS_patterns_11 = cog_analysis_u)

openxlsx::write.xlsx(excel_out, file = "data_out/3_cogaps_patterns.xlsx")
```
