...
load(file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/gtex-gene-counts-general.rda")
...
generalVSD <- varianceStabilizingTransformation(generalDES)
save(generalVSD, gtab, file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-vsd-unfiltered.rda")

##############################################################

## filter low expressed genes - general
m <- rowMeans(assay(generalVSD))
pdf("~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-avg-vsd-histogram.pdf", width=8, height=8)
...
generalVSDMeanFiltered <- generalVSD[ind,]
save(gtabMeanFiltered, generalVSDMeanFiltered, file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-vsd-mean-filtered.rda")
...
save(generalDESMeanFiltered, gtabMeanFiltered, file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-counts-mean-filtered.rda")
