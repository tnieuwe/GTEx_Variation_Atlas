...
load(file="gene_analysis_comparisons/original_lung_analysis/data_out//lung-vsd-mean-filtered.rda")
...
write.csv(gclusts, file="gene_analysis_comparisons/original_lung_analysis/data_out/lung-gene-clusters-high-variance-old.csv",
...
save(vsdHighVar, vsdHighVarCentered, vsdHighVarClust, vsdHighVarNoise, 
     ...
     file="gene_analysis_comparisons/original_lung_analysis/data_out/lung-high-variance-gene-data.rda")
...
write.csv(clusterProfiles, file="gene_analysis_comparisons/original_lung_analysis/data_out/lung-cluster-profiles.csv", quote=FALSE)
