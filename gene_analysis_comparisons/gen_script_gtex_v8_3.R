...
pdf("~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-high-variance-heatmap.pdf", width=8, height=8)
...
chm <- pheatmap(1-gcor, col=colors, breaks=brks,
                ...
                border_color = NA,
                filename="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-between-gene-correlation-high-variance-genes.pdf", 
                width=10, height=8)
#dev.off()
...
write.csv(gclusts, file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-gene-clusters-high-variance.csv",
...
chm <- pheatmap(1-gcorClust, col=colors, breaks=brks,
                ...
                annotation_colors = anno_colors,
                border_color = NA,
                filename="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-between-gene-correlation-high-variance-genes-clean.pdf", 
                width=10, height=8)
#dev.off()
...
chm <- pheatmap(1-gcorNoise, col=colors, breaks=brks,
                ...
                border_color = NA,
                filename="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-between-gene-correlation-high-variance-genes-noise.pdf", 
                width=10, height=8)
#dev.off()
...
pdf("~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-high-var-heatmap-clean-subj-info.pdf", width=8, height=8)
...
save(vsdHighVar, vsdHighVarCentered, vsdHighVarClust, vsdHighVarNoise, 
     ...
     file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-high-variance-gene-data.rda")

#########################################

## compute avg cluster expression for each sample
#load(file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-high-variance-gene-data.rda")
...
save(clusterProfiles, file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-cluster-profiles.rda")
write.csv(clusterProfiles, file="~/work2/tnieuwe1/data/gtex_v8/diff_samps/general/general-cluster-profiles.csv", quote=FALSE)
